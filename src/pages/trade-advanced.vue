...
<template>
  <div class="min-h-screen">
    <div class="max-w-7xl mx-auto px-4 py-8">
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Hybrid Trading</h1>
        <p class="text-gray-600 dark:text-gray-300">Advanced trading with optimal routing through AMM pools and orderbook</p>
      </div>
      ...
      <!-- Status Message -->
      <div v-if="tradeStatus" class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg">
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
          ...
          <!-- Market Stats -->
          <div v-if="currentPair" class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 mb-4">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Hybrid Trade</h3>
            ...
            <div class="mb-4">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                ...
                <span v-else>
                  Tries to achieve target price via optimal routing. May create orderbook order if no immediate match found
                </span>
              </p>
            </div>
                  ...
                  <div>
                    ...
                    <div class="space-y-1">
                      ...
                      <div 
                        ...
                        <span class="text-gray-600 dark:text-gray-400">{{ $formatNumber(ask.price * ask.quantity) }}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="space-y-1">
                      ...
                      <div 
                        ...
                        <span class="text-gray-600 dark:text-gray-400">{{ $formatNumber(bid.price * bid.quantity) }}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div v-if="selectedTab === 'orders'">
                ...
                <div v-else class="space-y-2">
                  ...
                  <div 
                    ...
                    <span class="text-gray-900 dark:text-white">{{ order.baseAssetSymbol }}/{{ order.quoteAssetSymbol }}</span>
                    ...
                    <span class="text-gray-900 dark:text-white">{{ order.price ? $formatNumber(order.price) : 'Market' }}</span>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 mb-4">
            ...
            <div class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
              <div>
                ...
                <p>Set a target price. System tries to achieve this price through optimal routing. If no immediate match is found, may create a standing order in the orderbook.</p>
              </div>
              <div>
                <strong class="text-gray-900 dark:text-white">Market Trades:</strong>
                <p>Execute immediately at the best available price across all liquidity sources (AMM pools + orderbook).</p>
              </div>
              <div>
                <strong class="text-gray-900 dark:text-white">Why Orders May Not Appear:</strong>
                <p>If your trade finds immediate liquidity (via AMM or existing orders), it executes instantly and won't create a standing order.</p>
              </div>
              <div>
                <strong class="text-gray-900 dark:text-white">Check Recent Trades:</strong>
                <p>If you don't see your order in "My Orders", check "Recent Trades" - your trade may have executed immediately.</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            ...
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
                ...
                <span class="text-green-600">{{ orderBook.bids.reduce((sum, b) => sum + b.quantity, 0).toFixed(4) }}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-500">Total Asks:</span>
                <span class="text-red-600">{{ orderBook.asks.reduce((sum, a) => sum + a.quantity, 0).toFixed(4) }}</span>
              </div>
              <div class="flex justify-between">
